        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConditionJson = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataProviderKey = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostMethod = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultCostMethod = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssetId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Quantity = table.Column<decimal>(type: "decimal(18,8)", precision: 18, scale: 8, nullable: false, defaultValue: 0m),
                    AvgCostPrice = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false, defaultValue: 0m),
                    ...
                    UnrealizedPnL = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: true),
                    UnrealizedPnLPct = table.Column<decimal>(type: "decimal(10,4)", precision: 10, scale: 4, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Commission = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false, defaultValue: 0m),
                    TaxAmount = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Alerts_Status_Active",
                table: "Alerts",
                column: "Status",
                filter: "[Status] = 'Active'");

            migrationBuilder.CreateIndex(
                name: "IX_Alerts_User_Status_Asset",
                table: "Alerts",
                columns: new[] { "UserId", "Status", "AssetId" });
            ...
            migrationBuilder.CreateIndex(
                name: "UIX_Portfolios_UserId_Default",
                table: "Portfolios",
            ...
            migrationBuilder.CreateIndex(
                name: "UIX_Positions_Portfolio_Asset",
                table: "Positions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trades_Portfolio_Asset",
                table: "Trades",
                columns: new[] { "PortfolioId", "AssetId" });

            migrationBuilder.CreateIndex(
                name: "IX_Trades_Portfolio_TradedAt",
                table: "Trades",
                columns: new[] { "PortfolioId", "TradedAt" });
